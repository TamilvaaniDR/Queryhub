...
const answerSchema = new mongoose_1.Schema({
    questionId: { type: mongoose_1.Schema.Types.ObjectId, required: true, ref: 'Question', index: true },
    authorId: { type: mongoose_1.Schema.Types.ObjectId, required: true, ref: 'User', index: true },
