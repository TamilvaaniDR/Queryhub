...
const categories = [
  ...
  { id: 'placements', name: 'Placements', icon: '💼', color: 'bg-cyan-100 text-cyan-800' },
  { id: 'exams', name: 'Exams', icon: '📝', color: 'bg-indigo-100 text-indigo-800' },
  { id: 'labs', name: 'Labs', icon: '🔬', color: 'bg-purple-100 text-purple-800' },
  { id: 'projects', name: 'Projects', icon: '🚀', color: 'bg-teal-100 text-teal-800' },
  { id: 'nss', name: 'NSS / Activities', icon: '🎯', color: 'bg-sky-100 text-sky-800' },
]
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-100 p-6 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <Link
            to="/ask"
            className="rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 px-4 py-2 text-sm font-semibold text-white shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5"
          >
            + Ask Question
          </Link>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="flex-1">
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 pl-10"
                />
            ...
            <div className="md:w-64">
              <select
                ...
                className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              >
      ...
      {me && !me.joinedCommunity && (
        <div className="rounded-2xl border border-dashed border-blue-200 bg-gradient-to-r from-blue-50 to-cyan-50 p-5 shadow-sm flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="text-sm font-semibold text-blue-700">Join the Community</div>
          ...
          <button
            ...
            className="mt-2 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 px-4 py-2 text-sm font-semibold text-white shadow-md hover:shadow-lg transition-all disabled:opacity-60 md:mt-0"
          >
        ...
        <div className="space-y-4">
          ...
          {items.map((x) => (
            <Link
              key={x.id}
              to={`/q/${x.id}`}
              className="block rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-200 group"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <h3 className="text-lg font-semibold text-slate-900 group-hover:text-blue-600 transition-colors line-clamp-2 flex-1">
                      {x.title}
                    </h3>
                    {x.hasAcceptedAnswer && (
